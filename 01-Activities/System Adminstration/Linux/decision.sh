...
curr_dir=$(pwd)
# Check to ensure the new directory name provided doesn't exist
...
cd $new_dir
pwd
# Use the touch command to create several empty files and run ls command to verify they are empty
for f in 1 2 3 4
do 
   touch file$f
done
