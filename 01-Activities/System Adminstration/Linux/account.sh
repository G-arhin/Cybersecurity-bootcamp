...
while [ $? -eq 0 ]
do 
  echo -n "[-] The username you choose already exists."
  echo ""
...
# Once a unique group name is choosen, we proceed to create it
groupadd $group
...
##The admin is prompted to create password for the new account
passwd $name
...
## Give the user and group owners full control over directory
chmod 770 /$name
